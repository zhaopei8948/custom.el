(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (use-package evil-surround evil-leader evil tabbar-ruler highlight-symbol popup-complete auto-yasnippet yasnippet auto-complete-c-headers auto-complete-clang auto-complete uptimes crontab-mode yagist whole-line-or-region whitespace-cleanup-mode wgrep-ag vc-darcs unfill undo-tree symbol-overlay switch-window smex session scratch rainbow-delimiters projectile project-local-variables page-break-lines nlinum multiple-cursors move-dup mmm-mode magit-gh-pulls list-unicode-display ivy-historian indent-guide ibuffer-vc highlight-escape-sequences guide-key gitignore-mode github-issues github-clone gitconfig-mode git-timemachine git-messenger git-blamed fullframe flycheck-color-mode-line fill-column-indicator expand-region exec-path-from-shell disable-mouse dired-sort dired+ diminish diff-hl default-text-scale darcsum counsel company-quickhelp command-log-mode color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized cmd-to-echo bug-reference-github browse-kill-ring browse-at-remote avy anzu alert ag)))
...
(maybe-require-package 'auto-complete-mode)
(maybe-require-package 'auto-complete-config)(ac-config-default)
(maybe-require-package 'yasnippet)(yas/global-mode 1)
